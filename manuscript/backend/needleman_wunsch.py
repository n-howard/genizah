...
def _generate_traceback_array(seq1, seq2, settings):
    ...
    arrow = "-"
    sofit_letters = settings.special
    gap_penalty = settings.gap_penalty
    gap_extension_penalty= settings.affine_penalty
    match_bonus = settings.match_bonus
...
def needleman_wunsch(seq1, seq2, settings):
    ''' Runs Needleman-Wunsch algorithm '''
    traceback_array,score = _generate_traceback_array(seq1, seq2, settings)
